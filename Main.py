...
'''
Krichalka = (input("ВВедите кричалку:")).split(" ")

Rythm = set()
for Fraza in Krichalka:
     Rythm.add(Fraza.count("а")+ Fraza.count("о")+ Fraza.count("е") +Fraza.count("я")+Fraza.count("ё")+Fraza.count("у")+Fraza.count("и")+Fraza.count("ю")+Fraza.count("э"))
if len(Rythm)>1:
    print ("Пам парам")
else     :
     print ("Парам пам-пам")
